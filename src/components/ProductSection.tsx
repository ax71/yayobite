...
const WHATSAPP_NUMBER = "628153888886";

const products = [
  {
    name: "Double Choco Gula Aren",
    tagline: "Manisnya Pas, Cokelatnya Bold",
    price: "Rp 65.000",
    image: "/products/brownie-double-choco.png",
  },
  {
    name: "Caramel Gula Aren",
    tagline: "Karamel Lumer, Gula Aren Asli",
    price: "Rp 60.000",
    image: "/products/brownie-gula-aren.png",
  },
  {
    name: "Matcha White Choco",
    tagline: "Segar & Creamy dalam Satu Gigitan",
    price: "Rp 70.000",
    image: "/products/brownie-matcha.png",
  },
  {
    name: "Red Velvet Cream Cheese",
    tagline: "Lembut Mewah, Cream Cheese-nya Nendang",
    price: "Rp 68.000",
    image: "/products/brownie-red-velvet.png",
  },
];
...
function generateWhatsAppUrl(productName: string) {
